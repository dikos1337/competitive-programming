...
for item in input_data:
    ...
    # print(left_side, password, required_char, min_length, max_length)
...
for item in data:
    ...
    if required_char_in_item >= item[
            'min_length'] and required_char_in_item <= item['max_length']:
        # print(True)
        counter += 1
