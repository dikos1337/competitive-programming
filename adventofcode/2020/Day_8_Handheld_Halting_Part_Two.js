  ...
  while (!op.wasRun) {
    switch (op.operation) {
      case "nop":
        ...
        pointer += 1;
        op.wasRun = true;
        runnned_op_stack.push(op);
        break;
      case "jmp":
        console.log(op, "jmp, pointer=", pointer);
        pointer += op.value;
        op.wasRun = true;
        runnned_op_stack.push(op);
        break;
      case "acc":
        console.log(op, "pointer=", pointer, "accumulator=", accumulator);
...
console.log(runnned_op_stack, "runnned_op_stack");
